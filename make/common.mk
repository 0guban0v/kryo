.PHONY: \
	...
	bootstrap bootstrap-fizzy bootstrap-campfire bootstrap-gitea generate-mcp-env fizzy-login-code deploy deploy-all observability-up observability-down observability-ps \

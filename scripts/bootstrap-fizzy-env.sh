...
BOOTSTRAP_FIZZY_ACCOUNT_NAME=$(resolve_env_setting "BOOTSTRAP_FIZZY_ACCOUNT_NAME" "Demo Platform")
BOOTSTRAP_FIZZY_OWNER_NAME=$(resolve_env_setting "BOOTSTRAP_FIZZY_OWNER_NAME" "Fizzy Admin")
BOOTSTRAP_FIZZY_OWNER_EMAIL=$(resolve_env_setting "BOOTSTRAP_FIZZY_OWNER_EMAIL" "fizzy-admin@demo.local")
BOOTSTRAP_FIZZY_TOKEN_DESCRIPTION=$(resolve_env_setting "BOOTSTRAP_FIZZY_TOKEN_DESCRIPTION" "demo-platform")
BOOTSTRAP_FIZZY_TOKEN_PERMISSION=$(resolve_env_setting "BOOTSTRAP_FIZZY_TOKEN_PERMISSION" "write")

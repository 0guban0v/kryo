...
BOOTSTRAP_CAMPFIRE_ADMIN_NAME=$(resolve_env_setting "BOOTSTRAP_CAMPFIRE_ADMIN_NAME" "Platform Admin")
BOOTSTRAP_CAMPFIRE_ADMIN_EMAIL=$(resolve_env_setting "BOOTSTRAP_CAMPFIRE_ADMIN_EMAIL" "campfire-admin@demo.local")
BOOTSTRAP_CAMPFIRE_ADMIN_PASSWORD=$(resolve_env_setting "BOOTSTRAP_CAMPFIRE_ADMIN_PASSWORD" "campfire-admin")
BOOTSTRAP_CAMPFIRE_ROOM_NAME=$(resolve_env_setting "BOOTSTRAP_CAMPFIRE_ROOM_NAME" "platform-ops")
BOOTSTRAP_CAMPFIRE_BOT_NAME=$(resolve_env_setting "BOOTSTRAP_CAMPFIRE_BOT_NAME" "Kryo")
